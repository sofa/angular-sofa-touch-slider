/**
 * angular-sofa-touch-slider - v0.1.0 - Mon Jan 12 2015 14:38:08 GMT+0100 (CET)
 * http://www.sofa.io
 *
...
angular.module('sofa.touchSlider', [
    'sofa-touch-slider.tpl.html',
    'sofa-touch-slider-indicator.tpl.html'
]);

angular.module('sofa-touch-slider-indicator.tpl.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('sofa-touch-slider-indicator.tpl.html',
...
angular.module('sofa-touch-slider.tpl.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('sofa-touch-slider.tpl.html',
...
.directive('sofaTouchSlider', ['$window', '$rootScope', function ($window, $rootScope) {
    ...
    return {
        ...
        templateUrl: 'sofa-touch-slider.tpl.html',
